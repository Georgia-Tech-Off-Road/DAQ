...
enum sensor_id_t : uint16_t
{
	...
	TIME_DASH_MS                 = 101,	//NumBytes: 2
	TIME_DASH_US                 = 102,	//NumBytes: 4
	TIME_AUXDAQ_MS               = 103,	//NumBytes: 2
	TIME_AUXDAQ_US               = 104,	//NumBytes: 4
	TIME_DIFF_MS                 = 105,	//NumBytes: 2
	TIME_DIFF_US                 = 106,	//NumBytes: 4
	TIME_DAATA_MS                = 107,	//NumBytes: 2
	TIME_DAATA_US                = 108,	//NumBytes: 4
	...
	SPEED_POSITION_GENERIC4      = 202,	//NumBytes: [2, 4] - Speed in RPM and position in ticks (4ppr sensor)
	SPEED_POSITION_GENERIC30     = 203,	//NumBytes: [2, 4] - Speed in RPM and position in ticks (30ppr sensor)
	SPEED_POSITION_GENERIC500    = 204,	//NumBytes: [2, 4] - Speed in RPM and position in ticks (500ppr sensor)
	SPEED_POSITION_GENERIC600    = 205,	//NumBytes: [2, 4] - Speed in RPM and position in ticks (600ppr sensor)
