...
LDS FRShock(A0, 225), FLShock(A2, 225, true), BRShock(A1, 200), BLShock(A3, 200), Steer(A6, 50), ECVT(A11, 50); //inputPin, travelMM, isReversed = false
PressureSensor BrakeFront(A12, 2000, 4600, 8200), BrakeBack(A13, 2000, 4600, 8200); //inputPin, maxPressure (PSI), r1 (Ohms), r2 (Ohms)
HallEffectSpeedSensor EngineSpeed(6, 6), WheelSpeed(5, 20); //inputPin, toneWheelTeeth, intervalLength = 50us, averagingAmount = 200
DS3232RTC RTC;
