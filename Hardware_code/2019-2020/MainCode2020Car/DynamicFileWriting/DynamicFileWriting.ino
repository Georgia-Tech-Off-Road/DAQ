...
uint32_t totTime = 8*10e6; //seconds before data collection stops (optional)
File dataFile;
File root;
File thisFile;
String fileName;
...
//  delayMicroseconds(500); //when 0, collection rate ~2200S/s, when 1500 collection rate ~450S/s
  
//  if(millis() > (120000 + 1400)){ //comment out this bit if data collection to be unlimited
//    while(1){
//      digitalWrite(13, LOW);
//      delay(500);
//      digitalWrite(13, HIGH);
